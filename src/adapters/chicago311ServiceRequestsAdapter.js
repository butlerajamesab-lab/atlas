...
export function normalizeChicago311(record) {
  ...
  return observationEnvelope({
    ...
    timestamp: created,
    jurisdiction: 'us_city_chicago',
    region: firstValue(record, ['community_area']) ? `chicago_community_area_${firstValue(record, ['community_area'])}` : 'us_city_chicago',
    channel: 'chicago_311',
    sourceSystem: 'chicago_311',
    sourceUrl: CHICAGO_311_SOURCE_URL,
    geography: {
      zip,
      ward: firstValue(record, ['ward']),
      community_area: firstValue(record, ['community_area']),
      latitude: firstValue(record, ['latitude']),
      longitude: firstValue(record, ['longitude']),
    },
    payload: {
      external_id: id,
      request_id: firstValue(record, ['sr_number', 'service_request_number', 'request_id']),
      request_type: requestType,
      short_code: firstValue(record, ['sr_short_code', 'short_code']),
      department,
      status: firstValue(record, ['status']),
      created_date: created,
      last_modified_date: firstValue(record, ['last_modified_date', 'updated_date']),
      closed_date: firstValue(record, ['closed_date', 'completion_date']),
      street_address: address,
      city: firstValue(record, ['city']) || 'Chicago',
      state: firstValue(record, ['state']) || 'IL',
      zip_code: zip,
      ward: firstValue(record, ['ward']),
      community_area: firstValue(record, ['community_area']),
    },
