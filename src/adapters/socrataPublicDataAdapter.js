...
export async function fetchSocrataRows({ apiUrl, limit = 1000, where = null, order = null }) {
...
export async function ingestSocrataObservations({ apiUrl, sourceId, jurisdictionId, moduleHint, normalize, limit = 1000, where = null, order = null, apiBaseUrl }) {
