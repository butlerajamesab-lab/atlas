...
export const PUBLIC_STREAM_CATALOG = [
  ...
  },
  {
    ...
    safety_profile: 'restricted',
    governance_contract_id: 'atlas-wa-ag-consumer-complaints-v1',
    status: 'active',
    source_url: 'https://data.wa.gov/Consumer-Protection/Consumer-Complaints/gpri-47xz',
  ...
  },
  {
    ...
    throughput_profile: 'high',
    safety_profile: 'default',
    governance_contract_id: 'atlas-nyc-311-service-requests-v1',
    status: 'active',
    source_url: 'https://data.cityofnewyork.us/Social-Services/311-Service-Requests/erm2-nwe9',
    api_url: 'https://data.cityofnewyork.us/resource/erm2-nwe9.json',
    update_frequency: 'hourly',
    description: 'New York City 311 service requests for municipal service pressure, agency routing, and neighborhood cluster signals.',
    tags: ['local', '311', 'municipal_services', 'new_york_city'],
  },
  {
    stream_id: 'chicago_311_service_requests',
    source_id: 'chicago_311',
    jurisdiction_id: 'chicago',
    module_hint: 'municipal_services',
    throughput_profile: 'high',
    safety_profile: 'default',
    governance_contract_id: 'atlas-chicago-311-service-requests-v1',
    status: 'active',
    ...
    update_frequency: 'hourly',
    description: 'Chicago 311 service requests for municipal service delays, neighborhood clusters, and agency routing pressure.',
